...
public class DLCategory {
    ...
    public func addActionButton(identifier: String?, title: String?) {
      ...
      let action = UNNotificationAction(identifier: identifier!, title: title!, options: [UNNotificationActionOptions.foreground, UNNotificationActionOptions.authenticationRequired])
